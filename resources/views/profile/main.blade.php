    ...
    <div class="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-1/3 flex flex-col gap-6">
            <div class="bg-[#1a1a1a] p-8 rounded-3xl border border-white/5 shadow-2xl flex flex-col items-center text-center">
                ...
                <p class="text-lime-400 text-xs font-bold uppercase tracking-widest mt-1">Verified Member</p>
        ...
        <div class="flex-1">
            <div class="bg-[#1a1a1a] p-8 md:p-10 rounded-3xl border border-white/5 shadow-2xl h-full">
                ...
                <div class="flex justify-between items-center mb-10">
                    ...
                    <a href="/profile/edit" wire:navigate class="px-6 py-2 bg-lime-400 text-black rounded-full font-bold text-xs hover:bg-lime-300 transition shadow-lg shadow-lime-400/20">
                        Edit Profile
                    </a>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                    ...
                    <div class="group min-w-0">
                        <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1 group-hover:text-lime-400 transition">Email Address</p>
                        <p class="text-white font-semibold text-lg border-b border-white/5 pb-2 break-all leading-snug">{{ auth()->user()?->email }}</p>
                    </div>

                    {{-- Sex --}}
                    <div class="group">
                        <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1 group-hover:text-lime-400 transition">Gender</p>
                        <p class="text-white font-semibold text-lg border-b border-white/5 pb-2">{{ ucfirst(auth()->user()?->sex ?? 'N/A') }}</p>
                    </div>

                    {{-- DOB --}}
                    <div class="group">
                        <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1 group-hover:text-lime-400 transition">Birthdate</p>
                    ...
                    {{-- Contact --}}
                    <div class="group">
                        <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1 group-hover:text-lime-400 transition">Phone Number</p>
                        <p class="text-white font-semibold text-lg border-b border-white/5 pb-2">{{ auth()->user()?->contact_number ?? 'No contact added' }}</p>
                    </div>

                    {{-- Address --}}
                    <div class="group md:col-span-2">
                        <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1 group-hover:text-lime-400 transition">Current Address</p>
